...
class norm:  
    def __init__(self, center, gazetarget, headrotvec, imsize, camparams, newfocal=960, newdistance=600):
        try:
            ...
            # print("HEADRIT ==",self.headrotvec)
            # print("TYPE",type(self.headrotvec))
    ...
    def GetImage(self, image):
        ...
        # self.im = cv2.resize(self.im,(256,256))
        print("w MAT",self.W_mat)
    ...
    def GetCoordinate(self, coordinate):
        ...
        rohit = np.dot(self.M_mat, coordinate).flatten()
        # print("m MAT",self.M_mat)
        return rohit
